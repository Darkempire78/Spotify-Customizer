...
function cleanTitleAuthorString(query) {
    return query.replaceAll(" ", "").replaceAll("'", "").replaceAll("?", "").replaceAll("!", "").replaceAll(".", "").replaceAll(",", "").replaceAll("(", "").replaceAll(")", "").replaceAll("&", "").toLowerCase();
}
